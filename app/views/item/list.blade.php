  ...
  <div class="row">
    ...
    <table class="pjTable">
      ...
      @foreach ($items as $item)
        <tr>
          <td><a href="#" class="delBtn" data-item-id="{{ $item->id }}"><i class="foundicon-remove"></i></a> <a href="item/view/{{ $item->id}}">{{ $item->name }}</a></td>
          <td>{{ $item->weight }}</td>
          <td>{{ $item->calories }}</td>
          <td>{{ $item->protein }}</td>
...
<div id="deleteModal" class="reveal-modal tiny" >
  ...
  <p><a href="#" class="button alert radius" id="deleteButton" data-item-id="">Yes Delete It!</a> <a href="" class="secondary button radius">Cancel</a></p>
